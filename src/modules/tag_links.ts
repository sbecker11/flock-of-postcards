...
export function createUrlAnchorTag(url: string, savedColor: string): string {
  ...
  const iconType = "url";
  return `<img class="icon ${iconType}-icon mono-color-sensitive" src="${monoColor.getIconUrl(iconType, iconColor)}" data-url="${url}" data-saved-color="${iconColor}" data-icontype="${iconType}"/>`;
}
...
export function createImgAnchorTag(img: string, savedColor: string): string {
  const iconColor = monoColor.getIconColor(savedColor);
  const iconType = "img";
  return `<img class="icon img-icon mono-color-sensitive" src="${monoColor.getIconUrl(iconType, iconColor)}" data-img="${img}" data-saved-color="${iconColor}" data-icontype="${iconType}"/>`;
}
